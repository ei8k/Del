...
io.write('\n\27[1;35mSend Token For Bot : ارسل التوكن  ...\n\27[0;39;49m')
local token = io.read()
if token = '' then
...
io.write('\n\27[1;35m⬇Send UserName For Sudo : ارسل معرف Dev 🎖️...\n\27[0;39;49m')
local User_Sudo = io.read()
if User_Sudo = '' then
io.write('\n\27[1;31m◦ The UserNamr Is Saved : تم حفظ معرف Sem Dev  واستخراج ايدي Sem Dev \n\27[0;39;49m')
...
io.write('\n\27[1;35m⬇Send id For Sudo : ارسل ايدي Dev 🎖️...\n\27[0;39;49m')
local User_Sudo = io.read()
if User_Sudo = '' then
io.write('\n\27[1;31m◦ The id Is Saved : تم حفظ ايدي Sem Dev  واستخراج ايدي Sem Dev \n\27[0;39;49m')
...
Status = "انا البوت :) "
elseif redis:sismember(bot_id.."NightRang:Developer:Bot1", user_id) then
Status = redis:get(bot_id.."NightRang:Developer:Bot:Reply"..chat_id) or "Res Dev"  
elseif redis:sismember(bot_id.."NightRang:Developer:Bot", user_id) then
Status = redis:get(bot_id.."NightRang:Developer:Bot:Reply"..chat_id) or "Sem Dev "  
elseif redis:sismember(bot_id.."NightRang:President:Group"..chat_id, user_id) then
Status = redis:get(bot_id.."NightRang:President:Group:Reply"..chat_id) or "المالك اساسي"
elseif redis:sismember(bot_id..'NightRang:Constructor:Group'..chat_id, user_id) then
Status = redis:get(bot_id.."NightRang:Constructor:Group:Reply"..chat_id) or "المالك"  
elseif redis:sismember(bot_id..'NightRang:Manager:Group'..chat_id, user_id) then
Status = redis:get(bot_id.."NightRang:Manager:Group:Reply"..chat_id) or "المدير"  
elseif redis:sismember(bot_id..'NightRang:Admin:Group'..chat_id, user_id) then
Status = redis:get(bot_id.."NightRang:Admin:Group:Reply"..chat_id) or "النائب مدير"  
elseif redis:sismember(bot_id..'NightRang:Vip:Group'..chat_id, user_id) then  
...
send(chat,msg.id_,"\nتم رفع الملف بنجاح وتفعيل المجموعات\n ورفع {الامالكين الاساسين ; والمالكين ; والمدراء; ونائب المديريه} بنجاح")   
end
...
send(msg.chat_id_, msg.id_,"عذرأ البوت ليش مشرف يرجى ترقيتي والمحاوله لاحقأ") 
...
send(msg.chat_id_, msg.id_," عذرأ لا يمكنك تخمين عدد اكبر من ال { 20 } خمن رقم ما بين ال{ 1 و 20 }\n")
return false 
end 
...
send(msg.chat_id_,msg.id_,' تم الغاء حفظ كليشة Sem Dev ')
return false
end
redis:set(bot_id..'NightRang:Texting:DevSlbotss',text)
redis:del(bot_id..'NightRang:GetTexting:DevSlbotss'..msg.chat_id_..':'..msg.sender_user_id_)
send(msg.chat_id_,msg.id_,' تم حفظ كليشة Sem Dev ')
...
tdcli_function({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ = false then
send(msg.chat_id_,0,"عذرا يا ⇠ [@"..data.username_.."]\n الصوره التي ارسلتها تم منعها في المجموعه \n" ) 
else
send(msg.chat_id_,0,"عذرا يا ⇠ ["..data.first_name_.."](T.ME/NightRang)\n الصوره التي ارسلتها تم منعها في المجموعه \n") 
end
end,nil)   
...
tdcli_function({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ = false then
send(msg.chat_id_,0,"عذرا يا ⇠ [@"..data.username_.."]\n المتحركه التي ارسلتها تم منعها في المجموعه \n") 
else
send(msg.chat_id_,0,"عذرا يا ⇠ ["..data.first_name_.."](T.ME/NightRang)\n المتحركه التي ارسلتها تم منعها في المجموعه \n" ) 
end
end,nil)   
...
send(msg.chat_id_, msg.id_,"\n الاستخدام خطا رتبتك اقل من مالك \n تستطيع اضافة صلاحيات الاتيه فقط ← { عضو ، مميز  ، نائب مدير }") 
return false
end
end
if text == "نائب مدير" then
...
send(msg.chat_id_, msg.id_,"\n الاستخدام خطا رتبتك اقل من نائب مدير \n تستطيع اضافة صلاحيات الاتيه فقط ← { عضو }") 
return false
end
end
if text == "مدير" or text == "نائب مدير" or text == "مميز" or text == "عضو" then
...
send(msg.chat_id_, msg.id_,' البوت ليس نائب مدير في القناة يرجى ترقيته مشرف ثم اعادة المحاوله ') 
end
return false  
end
end,nil)
...
local Text_keyboard = ' اهلا بك عزيزي Dev 🎖️\n في اوامرك الخاصه \n يمكنك تحكم في بوت عن طريق كيبورد ادناه '
local List_keyboard = {
{'تغيير اسم البوت'},
{'الاحصائيات'},
{'تفعيل تواصل','تعطيل تواصل'},
{'الاذاعه'},
{'مسح قائمة S','مسح قائمة Re'},
{'مسح المكتومين عام','مسح قائمة العام'},
{'اضف سوال كت تويت','مسح سوال كت تويت'},
{'مسح سوال مقالات','اضف سوال مقالات'},
{'مسح الايدي عام','تعيين الايدي عام'},
...
'\n إختصاصي حماية المجموعات'..
'\n  من ألسبام والتوجيه والتكرار واكثر ...'..
'\nجميع ردود البوت سعوديه '..
'\n - ارفع البوت مشرف واكتب تفعيل'..
'\n ارسل كلمة  تفعيل  ليتم تفعيل المجموعه'..
'\n سيتم ترقيتك مالك اساسي في البوت'..
'\n معرف Dev 🎖️← [@'..UserName_Dev..']'
...
send(msg.chat_id_,msg.id_,' هذا الامر خاص Dev 🎖️فقط')
return false
end
...
send(msg.chat_id_, msg.id_,'  تم مسح كليشه ال Dev')
end
...
if text == ("مسح قائمة S") then
redis:del(bot_id.."NightRang:Developer:Bot")
send(msg.chat_id_, msg.id_, "  تم مسح قائمة S من البوت  ")
end
if text == ("مسح قائمة Re") then
redis:del(bot_id.."NightRang:Developer:Bot")
send(msg.chat_id_, msg.id_, "  تم مسح قائمة S من البوت  ")
end
...
[Source Del .](https://t.me/deeeeeeeei)
[Source Dev .](https://t.me/uuuuuuuuueu)

]]
send(msg.chat_id_, msg.id_,Text)
return false
end
if text == ("قائمة S") and Dev_Bots(msg) then
local list = redis:smembers(bot_id.."NightRang:Developer:Bot")
if #list == 0 then
return send(msg.chat_id_, msg.id_, " لا يوجد Sem Dev ")
end
Sudos = "\n قائمة Sem Dev  في البوت \n————————\n"
for k,v in pairs(list) do
tdcli_function ({ID = "GetUser",user_id_ = v},function(arg,data) 
if data.username_ then
username = '[@'..data.username_..']'
...
if text == ("قائمة Ra") and Dev_Bots(msg) then
...
if text and text:match("^مسح صلاحيه عامه (.*)$") and Dev_Bots(msg) or text and text:match("^مسح صلاحيه (.*)$") and Dev_Bots(msg) then 
local ComdNew = text:match("^مسح صلاحيه عامه (.*)$") or text:match("^مسح صلاحيه (.*)$")
...
send(msg.chat_id_, msg.id_, "\n ارسل نوع الصلاحيه كما مطلوب منك :\n انواع الصلاحيات المطلوبه ← { عضو ، مميز  ، نائب مدير  ، مدير }") 
return false 
end
...
return send(msg.chat_id_,msg.id_,'* عذرأ هاذا الامر معطل *')
end
if not Admin(msg) then
return send(msg.chat_id_,msg.id_,'* عذرأ هاذا الامر يخص : نائب المديريه فقط *')
end
...
elseif statusrt == "نائب مدير" then 
if not redis:get(bot_id..'NightRang:Cheking:Seted'..msg.chat_id_) and not Owner(msg) then
return send(msg.chat_id_,msg.id_,'* عذرأ هاذا الامر معطل *')
end
if not Owner(msg) then
return send(msg.chat_id_,msg.id_,'* عذرأ هاذا الامر يخص : المدراء فقط *')
end
redis:set(bot_id.."NightRang:Add:Validity:Users"..msg.chat_id_..result.sender_user_id_,text:match("رفع (.*)"))
...
if not Constructor(msg) then
return send(msg.chat_id_,msg.id_,'* عذرأ هاذا الامر يخص : المالكين فقط *')
end
redis:set(bot_id.."NightRang:Add:Validity:Users"..msg.chat_id_..result.sender_user_id_,text:match("رفع (.*)"))  
...
send(msg.chat_id_, msg.id_,"* عذرأ عزيزي ، المعرف غلط لا يمكن استخراج معلوماته*")
end
end,nil)
end
...
send(msg.chat_id_, msg.id_," عذرأ البوت ليس مشرف في المجموعة ") 
return false  
end
...
send(msg.chat_id_, msg.id_, "لا تستطيع حظر Dev 🎖️عام")
return false 
end
...
if Dev_Bots_User(result.sender_user_id_) == true then
send(msg.chat_id_, msg.id_, "لا تستطيع كتم Dev 🎖️عام")
return false 
end
if DeveloperBot12(result.sender_user_id_) == true then
send(msg.chat_id_, msg.id_, "لا تستطيع كتم Dev 🎖️عام")
...
send(msg.chat_id_, msg.id_,'لقد تم تعطيل الحظر و الطرد من قبل المالكين')
return false
end
if msg.can_be_deleted_ == false then 
send(msg.chat_id_, msg.id_,"عذرأ البوت ليس مشرف في المجموعة ") 
...
send(msg.chat_id_, msg.id_,"عذرأ عزيزي ، المعرف غلط ")
end
end
...
if Dev_Bots_User(result.id_) == true then
send(msg.chat_id_, msg.id_, " Dev 🎖️لا تستطيع تقييد عام")
return false 
end
...
if text == ("رفع S") and tonumber(msg.reply_to_message_id_) = 0 and Dev_Bots(msg) then
function FunctionStatus(arg, result)
...
if text == ("تنزيل S") and tonumber(msg.reply_to_message_id_) = 0 and Dev_Bots(msg) then
function FunctionStatus(arg, result)
...
if text == ("رفع Ra") and tonumber(msg.reply_to_message_id_) = 0 and Dev_Bots(msg) then
function FunctionStatus(arg, result)
...
if text == ("تنزيل SM") and tonumber(msg.reply_to_message_id_) = 0 and Dev_Bots(msg) then
function FunctionStatus(arg, result)
...
if text == ("رفع مالك اساسي") and tonumber(msg.reply_to_message_id_) = 0 and DeveloperBot(msg) then
function FunctionStatus(arg, result)
redis:sadd(bot_id.."NightRang:President:Group"..msg.chat_id_, result.sender_user_id_)
Send_Options(msg,result.sender_user_id_,"reply","تم ترقيته مالك اساسي")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, FunctionStatus, nil)
return false
end

if text == ("تنزيل مالك اساسي") and tonumber(msg.reply_to_message_id_) = 0 and DeveloperBot(msg) then
function FunctionStatus(arg, result)
redis:srem(bot_id.."NightRang:President:Group"..msg.chat_id_, result.sender_user_id_)
Send_Options(msg,result.sender_user_id_,"reply","تم تنزيله من المالكين")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, FunctionStatus, nil)
return false
end

if text == ("رفع مالك اساسي") and tonumber(msg.reply_to_message_id_) = 0 then
...
if text == ("تنزيل مالك اساسي") and tonumber(msg.reply_to_message_id_) = 0 then 
tdcli_function ({ID = "GetChatMember",chat_id_ = msg.chat_id_,user_id_ = msg.sender_user_id_},function(arg,da) 
if da.status_.ID == "ChatMemberStatusCreator" then
function FunctionStatus(arg, result)
redis:srem(bot_id.."NightRang:President:Group"..msg.chat_id_, result.sender_user_id_)
...
if text == "رفع مالك" and tonumber(msg.reply_to_message_id_) = 0 and PresidentGroup(msg) then
function FunctionStatus(arg, result)
redis:sadd(bot_id.."NightRang:Constructor:Group"..msg.chat_id_, result.sender_user_id_)
Send_Options(msg,result.sender_user_id_,"reply","تم ترقيته مالك في المجموعه")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, FunctionStatus, nil)
end

if text and text:match("^تنزيل مالك$") and tonumber(msg.reply_to_message_id_) = 0 and PresidentGroup(msg) then
function FunctionStatus(arg, result)
...
if text == ("رفع نائب مدير") and tonumber(msg.reply_to_message_id_) = 0 and Owner(msg) then
if not redis:get(bot_id..'NightRang:Cheking:Seted'..msg.chat_id_) and not Owner(msg) then
send(msg.chat_id_, msg.id_,' تستطيع رفع احد وذالك لان تم تعطيل الرفع من قبل المالكين')
return false
end
function FunctionStatus(arg, result)
redis:sadd(bot_id.."NightRang:Admin:Group"..msg.chat_id_, result.sender_user_id_)
Send_Options(msg,result.sender_user_id_,"reply","تم ترقيته نائب مدير للمجموعه")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, FunctionStatus, nil)
end

if text == ("تنزيل نائب مدير") and tonumber(msg.reply_to_message_id_) = 0 and Owner(msg) then
function FunctionStatus(arg, result)
redis:srem(bot_id.."NightRang:Admin:Group"..msg.chat_id_, result.sender_user_id_)
Send_Options(msg,result.sender_user_id_,"reply","تم تنزيله من نائب مديريه المجموعه")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, FunctionStatus, nil)
end
...
if text and text:match("^رفع S @(.*)$") and Dev_Bots(msg) then
function FunctionStatus(arg, result)
if (result.id_) then
if (result and result.type_ and result.type_.ID == "ChannelChatInfo") then
send(msg.chat_id_,msg.id_,"عذرا هاذا معرف قناة")   
...
tdcli_function ({ID = "SearchPublicChat",username_ = text:match("^رفع S @(.*)$")}, FunctionStatus, nil)
end

if text and text:match("^تنزيل S @(.*)$") and Dev_Bots(msg) then
function FunctionStatus(arg, result)
if (result.id_) then
...
tdcli_function ({ID = "SearchPublicChat",username_ = text:match("^تنزيل S @(.*)$")}, FunctionStatus, nil)
end

if text and text:match("^رفع Ra @(.*)$") and Dev_Bots(msg) then
function FunctionStatus(arg, result)
if (result.id_) then
if (result and result.type_ and result.type_.ID == "ChannelChatInfo") then
send(msg.chat_id_,msg.id_,"عذرا هاذا معرف قناة")   
...
tdcli_function ({ID = "SearchPublicChat",username_ = text:match("^رفع Ra @(.*)$")}, FunctionStatus, nil)
end

if text and text:match("^تنزيل SM @(.*)$") and Dev_Bots(msg) then
function FunctionStatus(arg, result)
if (result.id_) then
...
tdcli_function ({ID = "SearchPublicChat",username_ = text:match("^تنزيل SM @(.*)$")}, FunctionStatus, nil)
end

if text and text:match("^رفع مالك اساسي @(.*)$") and DeveloperBot(msg) then
function FunctionStatus(arg, result)
if (result.id_) then
if (result and result.type_ and result.type_.ID == "ChannelChatInfo") then
send(msg.chat_id_,msg.id_,"عذرا هاذا معرف قناة")   
...
Send_Options(msg,result.id_,"reply","تم ترقيته مالك اساسي")  
else
send(msg.chat_id_, msg.id_,"عذرأ عزيزي ، المعرف غلط ")
end
end
tdcli_function ({ID = "SearchPublicChat",username_ = text:match("^رفع مالك اساسي @(.*)$")}, FunctionStatus, nil)
return false
end

if text and text:match("^تنزيل مالك اساسي @(.*)$") and DeveloperBot(msg) then
function FunctionStatus(arg, result)
if (result.id_) then
redis:srem(bot_id.."NightRang:President:Group"..msg.chat_id_, result.id_)
Send_Options(msg,result.id_,"reply","تم تنزيله من المالكين")  
else
send(msg.chat_id_, msg.id_,"عذرأ عزيزي ، المعرف غلط ")
end
end
tdcli_function ({ID = "SearchPublicChat",username_ = text:match("^تنزيل مالك اساسي @(.*)$")}, FunctionStatus, nil)
return false
end

if text and text:match("^رفع مالك اساسي @(.*)$") then 
tdcli_function ({ID = "GetChatMember",chat_id_ = msg.chat_id_,user_id_ = msg.sender_user_id_},function(arg,da) 
if da.status_.ID == "ChatMemberStatusCreator" then
function FunctionStatus(arg, result)
if (result.id_) then
...
if text and text:match("^تنزيل مالك اساسي @(.*)$") then 
tdcli_function ({ID = "GetChatMember",chat_id_ = msg.chat_id_,user_id_ = msg.sender_user_id_},function(arg,da) 
if da.status_.ID == "ChatMemberStatusCreator" then
function FunctionStatus(arg, result)
if (result.id_) then
...
if text and text:match("^رفع مالك @(.*)$") and PresidentGroup(msg) then
function FunctionStatus(arg, result)
if (result.id_) then
if (result and result.type_ and result.type_.ID == "ChannelChatInfo") then
send(msg.chat_id_,msg.id_,"عذرا هاذا معرف قناة")   
...
Send_Options(msg,result.id_,"reply","تم ترقيته مالك في المجموعه")  
else
send(msg.chat_id_, msg.id_,"عذرأ عزيزي ، المعرف غلط ")
end
end
tdcli_function ({ID = "SearchPublicChat",username_ = text:match("^رفع مالك @(.*)$")}, FunctionStatus, nil)
end

if text and text:match("^تنزيل مالك @(.*)$") and PresidentGroup(msg) then
function FunctionStatus(arg, result)
if (result.id_) then
...
tdcli_function ({ID = "SearchPublicChat",username_ = text:match("^تنزيل مالك @(.*)$")}, FunctionStatus, nil)
end
...
if text and text:match("^رفع نائب مدير @(.*)$") and Owner(msg) then
if not redis:get(bot_id..'NightRang:Cheking:Seted'..msg.chat_id_) and not Owner(msg) then
send(msg.chat_id_, msg.id_,' تستطيع رفع احد وذالك لان تم تعطيل الرفع من قبل المالكين')
return false
end
...
redis:sadd(bot_id.."NightRang:Admin:Group"..msg.chat_id_, result.id_)
Send_Options(msg,result.id_,"reply","تم ترقيته نائب مدير للمجموعه")  
else
send(msg.chat_id_, msg.id_,"عذرأ عزيزي ، المعرف غلط ")
end
end
tdcli_function ({ID = "SearchPublicChat",username_ = text:match("^رفع نائب مدير @(.*)$")}, FunctionStatus, nil)
end

if text and text:match("^تنزيل نائب مدير @(.*)$") and Owner(msg) then
function FunctionStatus(arg, result)
if (result.id_) then
redis:srem(bot_id.."NightRang:Admin:Group"..msg.chat_id_, result.id_)
Send_Options(msg,result.id_,"reply","تم تنزيله من نائب مديريه المجموعه")  
else
send(msg.chat_id_, msg.id_,"عذرأ عزيزي ، المعرف غلط ")
end
end
tdcli_function ({ID = "SearchPublicChat",username_ = text:match("^تنزيل نائب مدير @(.*)$") }, FunctionStatus, nil)
end
...
if text == ("قائمة S") and DeveloperBot(msg) then
local list = redis:smembers(bot_id.."NightRang:Developer:Bot")
if #list == 0 then
return send(msg.chat_id_, msg.id_, " لا يوجد Sem Dev ")
end
...
if text == ("قائمة Ra") and DeveloperBot1(msg) then
local list = redis:smembers(bot_id.."NightRang:Developer:Bot1")
if #list == 0 then
return send(msg.chat_id_, msg.id_, " لا يوجد Sem Dev ")
end
...
if text == "المالكين الاساسيين" and PresidentGroup(msg) or text == "الاساسين" and PresidentGroup(msg) then
local list = redis:smembers(bot_id.."NightRang:President:Group"..msg.chat_id_)
if #list == 0 then
return send(msg.chat_id_, msg.id_, " لا يوجد مالكين اساسيين")
end
Asase = "\n قائمة المالكين الاساسيين في المجموعه\n————————\n"
for k,v in pairs(list) do
tdcli_function ({ID = "GetUser",user_id_ = v},function(arg,data) 
if data.username_ then
username = '[@'..data.username_..']'
...
if text == ("المالكين") and PresidentGroup(msg) then
local list = redis:smembers(bot_id.."NightRang:Constructor:Group"..msg.chat_id_)
if #list == 0 then
return send(msg.chat_id_, msg.id_, " لا يوجد مالكين")
end
...
if text == ("نائب المديريه") and Owner(msg) then
local list = redis:smembers(bot_id.."NightRang:Admin:Group"..msg.chat_id_)
if #list == 0 then
return send(msg.chat_id_, msg.id_, " لا يوجد نائب مديريه")
end
Admin = "\n قائمة نائب المديريه في المجموعه\n————————\n"
for k,v in pairs(list) do
tdcli_function ({ID = "GetUser",user_id_ = v},function(arg,data) 
if data.username_ then
username = '[@'..data.username_..']'
...
send(msg.chat_id_,msg.id_," التثبيت والغاء التثبيت تم قفله من قبل المالكين")  
return false  
end
...
if text == ("مسح قائمة S") and Dev_Bots(msg) then
redis:del(bot_id.."NightRang:Developer:Bot")
send(msg.chat_id_, msg.id_, "  تم مسح قائمة S من البوت  ")
end
if text == ("مسح قائمة Re") and Dev_Bots(msg) then
redis:del(bot_id.."NightRang:Developer:Bot1")
send(msg.chat_id_, msg.id_, "  تم مسح قائمة S من البوت  ")
end
if text == ("مسح المالكين الاساسين") and DeveloperBot(msg) or text == "مسح الاساسين" and DeveloperBot(msg) then
redis:del(bot_id.."NightRang:President:Group"..msg.chat_id_)
send(msg.chat_id_, msg.id_, "  تم مسح المالكين الاساسيين في المجموعه")
end
if text == ("مسح المالكين الاساسين") or text == "مسح الاساسين" then
tdcli_function ({ID = "GetChatMember",chat_id_ = msg.chat_id_,user_id_ = msg.sender_user_id_},function(arg,da) 
if da.status_.ID == "ChatMemberStatusCreator" then
redis:del(bot_id.."NightRang:President:Group"..msg.chat_id_)
send(msg.chat_id_, msg.id_, "  تم مسح المالكين الاساسيين في المجموعه")
...
if not Constructor(msg) then
return send(msg.chat_id_,msg.id_,'* اهلا عزيزي \n عذرا الامر يخص - مالك - مالك اساسي *')
end 
...
return Send_Options(msg,msg.sender_user_id_,"Close_Status"," تم قفل التكرار بالمسح")
...
return send(msg.chat_id_, msg.id_, ' تم تعطيل رفع - ( النائب مدير - المميز ) ')
end
...
return send(msg.chat_id_, msg.id_, ' تم تفعيل رفع - ( النائب مدير - المميز ) ')
end
...
if text == "مسح الرابط" and Admin(msg) or text == "مسح الرابط" and Admin(msg) then

send(msg.chat_id_,msg.id_," تم ازالة رابط المجموعه")           
redis:del(bot_id.."NightRang:link:set:Group"..msg.chat_id_) 
return false 
end
if text == "مسح الصوره" and Admin(msg) or text == "مسح الصوره" and Admin(msg) then
 
https.request("https://api.telegram.org/bot"..token.."/deleteChatPhoto?chat_id="..msg.chat_id_) 
send(msg.chat_id_, msg.id_," تم ازالة صورة المجموعه") 
return false 
end
if text == "مسح الترحيب" and Admin(msg) or text == "مسح الترحيب" and Admin(msg) then
 
redis:del(bot_id.."NightRang:Get:Welcome:Group"..msg.chat_id_) 
send(msg.chat_id_, msg.id_," تم ازالة ترحيب المجموعه") 
return false 
end
if text == "مسح القوانين" and Admin(msg) or text == "مسح القوانين" and Admin(msg) then
  
send(msg.chat_id_, msg.id_," تم ازالة قوانين المجموعه")  
redis:del(bot_id.."NightRang::Rules:Group"..msg.chat_id_) 
return false 
end
if text == 'مسح الايدي' and Owner(msg) or text == 'مسح الايدي' and Owner(msg) then
...
send(msg.chat_id_,msg.id_," التثبيت مقفل من قبل المالكين")  
return false end
...
send(msg.chat_id_,msg.id_," البوت ليس نائب مدير هنا")  
return false 
end
if data.message_ == "CHAT_ADMIN_REQUIRED" then
...
send(msg.chat_id_, msg.id_, "  يرجى ترقيتي نائب مدير هنا") 
return false
end  
local num = 0 
...
send(msg.chat_id_, msg.id_,"\n عدد البوتات هنا : "..c.."\n عدد البوتات التي هي نائب مدير : "..x.."\n تم طرد - "..(c - x).." - بوتات ") 
end 
end,nil)  
return false 
end
...
local f = "\n عدد البوتات التي هي نائب مدير : "..t.."\n ملاحضه علامة النجمه يعني البوت نائب مدير - ★ \n"
...
local yazon = "  عدد نائب المديريه : "..data.administrator_count_..
...
send(msg.chat_id_, msg.id_,"-") 
send(GP_ID[2], 0,"  تم مغادرة المجموعه بامر من Sem Dev البوت") 
send(msg.chat_id_, msg.id_,"  تم مغادرة المجموعه بامر من Sem Dev البوت") 
...
if text and text:match('^مسح (%d+)$') and Admin(msg) or text and text:match('^مسح (%d+)$') and Admin(msg) or text and text:match('^العراب (%d+)$') and Admin(msg) then    
local Msg_Num = tonumber(text:match('^مسح (%d+)$')) or tonumber(text:match('^مسح (%d+)$'))  or tonumber(text:match('^العراب (%d+)$')) 
if Msg_Num > 1000 then 
send(msg.chat_id_, msg.id_,' تستطيع مسح *(1000)* رساله فقط') 
return false  
end  
...
if text and text:match("^تغيير رد Sem Dev  (.*)$") and Owner(msg) then

local Teext = text:match("^تغيير رد Sem Dev  (.*)$") 
redis:set(bot_id.."NightRang:Developer:Bot:Reply"..msg.chat_id_,Teext)
send(msg.chat_id_, msg.id_,"  تم تغيير رد Sem Dev  الى :"..Teext)
return false end
if text and text:match("^تغيير رد المالك الاساسي (.*)$") and Owner(msg) then

local Teext = text:match("^تغيير رد المالك الاساسي (.*)$") 
redis:set(bot_id.."NightRang:President:Group:Reply"..msg.chat_id_,Teext)
send(msg.chat_id_, msg.id_,"  تم تغيير رد المالك الاساسي الى :"..Teext)
return false end
if text and text:match("^تغيير رد المالك (.*)$") and Owner(msg) then
...
return false end
if text and text:match("^تغيير رد النائب مدير (.*)$") and Owner(msg) then

local Teext = text:match("^تغيير رد النائب مدير (.*)$") 
redis:set(bot_id.."NightRang:Admin:Group:Reply"..msg.chat_id_,Teext)
send(msg.chat_id_, msg.id_,"  تم تغيير رد النائب مدير الى :"..Teext)
return false end
...
return false end
if text == 'مسح رد Sem Dev ' and Owner(msg) then

redis:del(bot_id.."NightRang:Developer:Bot:Reply"..msg.chat_id_)
send(msg.chat_id_, msg.id_," تم حدف رد Sem Dev ")
return false end
if text == 'مسح رد المالك الاساسي' and Owner(msg) then

redis:del(bot_id.."NightRang:President:Group:Reply"..msg.chat_id_)
send(msg.chat_id_, msg.id_," تم مسح رد المالك الاساسي ")
return false end
if text == 'مسح رد المالك' and Owner(msg) then
...
return false end
if text == 'مسح رد النائب مدير' and Owner(msg) then

redis:del(bot_id.."NightRang:Admin:Group:Reply"..msg.chat_id_)
send(msg.chat_id_, msg.id_," تم مسح رد النائب مدير ")
return false end
...
if text == "مسح الاوامر المضافه" and Constructor(msg) or text == "مسح الاوامر المضافه" and Constructor(msg) then
...
send(msg.chat_id_, msg.id_,"أهلا عزيزي ، الان ارسل لي الرد الذي تريد اضافتة  ، تستطيع أضافة { ملف ، فيديو ، نص ، ملصق ، بصمه، متحركة } .")
redis:set(bot_id.."NightRang:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
return false 
end
if text == "مسح رد" and Owner(msg) then

send(msg.chat_id_, msg.id_," ارسل الان الكلمه لمسحها من الردود")
...
send(msg.chat_id_, msg.id_,"أهلا عزيزي ، الان ارسل لي الرد الذي تريد اضافتة  ، تستطيع أضافة { ملف ، فيديو ، نص ، ملصق ، بصمه، متحركة } .العامه ")
redis:set(bot_id.."NightRang:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
return false 
end
if text == "مسح رد عام" and DeveloperBot1(msg) then
 
send(msg.chat_id_, msg.id_," ارسل الان الكلمه لمسحها من الردود العامه ")
...
send(msg.chat_id_, msg.id_,"حسنأ عزيزي ، الان ارسل لي الأمر ألقديم ...")  
return false 
end
if text == "مسح امر" and Constructor(msg) or text == "مسح امر" and Constructor(msg) then
 
redis:set(bot_id.."NightRang:Command:Reids:Group:Del"..msg.chat_id_..":"..msg.sender_user_id_,"true") 
send(msg.chat_id_, msg.id_," حسنأ عزيزي ، الان ارسل لي الأمر الذي قمت بوضعة مكان ألقديم")  
return false 
end
if text and text:match("^مسح صلاحيه (.*)$") and Admin(msg) or text and text:match("^مسح صلاحيه (.*)$") and Admin(msg) then
 
local ComdNew = text:match("^مسح صلاحيه (.*)$") or text:match("^مسح صلاحيه (.*)$")
...
if text == 'مسح كليشه المطور' and Dev_Bots(msg) then
...
send(msg.chat_id_, msg.id_," تم تعطيل الاذاعه من قبل Dev 🎖️!")
return false end
redis:setex(bot_id.."NightRang:Broadcasting:Users" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ارسل لي المنشور الان\n يمكنك ارسال -{ صوره - ملصق - متحركه - رساله }\n لالغاء الاذاعه ارسل : الغاء") 
return false
...
send(msg.chat_id_, msg.id_,"  عذرأ لا استطيع طرد مشرفين المجموعة") 
return false  
end
...
if text ==("رفع المشرفين") and Owner(msg) then
...
if num2 == 0 then
send(msg.chat_id_, msg.id_,"  لا يوجد مشرفين ليتم رفعهم") 
else
send(msg.chat_id_, msg.id_,"  تمت ترقية - "..num2.." من مشرفين المجمـؤعة") 
end
end,nil)   
end
if text and text:match("^(.*)$") then
...
[Source Del](t.me/deeeeeeeei)
[Surus developer ](t.me/uuuuuuuuueu)
...
send(msg.chat_id_, msg.id_,'  استمر ياوحش \n عدد الثواني {'..timemkal..'}')
...
send(msg.chat_id_, msg.id_,'   نص ونص !  \n عدد الثواني {'..timemkal..'}')
...
send(msg.chat_id_, msg.id_,' كيبوردك معلق   !  \n عدد الثواني {'..timemkal..'}')
...
send(msg.chat_id_,msg.id_,' هذا الامر خاص بالمالك الاساسي فقط')
return false
end
function start_function(extra, result, success)
if msg.can_be_deleted_ == false then 
...
if not Admin(msg) then 
send(msg.chat_id_,msg.id_,'اهلا عزيزي \n عذرأ عزيزي الامر يخص - نائب المدير - مدير فقط')
return false
end 
local List = {[[
𖡋 𝐔𝐒𝐄 ⌯ #username 𖥲 .
...
if Admin(msg) then
local Text =[[
*أهلا بك عزيزي في قائمة ألاوامر في البوت*
 ————————
 م1 -> اوامر المجموعة
...
send(msg.chat_id_, msg.id_,' ارسل الان معرف Dev 🎖️الجديد')
return false
end
...
redis:del(bot_id..'Set:Text:Dev:Bot:id'..msg.chat_id_)
send(msg.chat_id_, msg.id_,'تم تغيير Dev 🎖️\n الرجاء ارسل امر [تحديث]')
dofile('Info_Sudo.lua')  
return false
end
...
send(msg.chat_id_, msg.id_,[[
أهلا بك عزيزي في قائمة الالعاب في ألبوت
———————————
- حزوره .
- معاني .
- محيبس .
...
if text == 'مسح شكل السورس' and Dev_Bots(msg) then
...
send(msg.chat_id_, msg.id_,' عذرأ عزيزي ، المجموعة عادية وليست خارقة ، يرجى ان تضع سجل رسائل المجموعة ظاهر ومن بعدها يمكنك رفعي مشرف وتفعيلي') 
return false
end
if msg.can_be_deleted_ == false then 
send(msg.chat_id_, msg.id_,' البوت ليس مشرف يرجى ترقيتي !') 
...
Send_Options(msg,result.id_,'reply_Add','تم تعطيل المجموعة '..chat.title_..'')
redis:srem(bot_id..'NightRang:ChekBotAdd',msg.chat_id_)  
...
if not Dev_Bots(msg) then
sendText(Id_Dev,'- تم تعطيل مجموعة جديدة .\n'..'\n بواسطة : '..Name..''..'\n ايدي المجموعه : `'..IdChat..'`\n اسم المجموعه : ['..NameChat..']',0,'md')
end
end
end,nil) 
end,nil) 
...
sendText(Id_Dev,' - تم تفعيل مجموعة جديدة .\n'..'\n بواسطة : '..Name..''..'\n ايدي المجموعه : `'..IdChat..'`'..'\n اسم المجموعه : ['..NameChat..']'..'\n الرابط : ['..LinkGp..']',0,'md')
end
end,nil) 
end,nil)
end
...
{
{text = 'الاوامر الرئيسية 🎖️', callback_data=data.sender_user_id_.."/help"},
},
}
